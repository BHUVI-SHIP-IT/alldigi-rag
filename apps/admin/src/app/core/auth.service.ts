...
const ROLE_KEY = 'rag_admin_role';
const EMAIL_KEY = 'rag_admin_email';
...
export class AuthService {
  ...
  readonly isAdmin = computed(() => this.roleState() === 'Admin' && !!this.tokenState());
  readonly isSignedIn = computed(() => !!this.tokenState());
